...
export default function Calendario() {
  ...
  return (
    <div className="container_calendario">
      ...
      {/* Días de la semana */}
      <div className="calensario_dias_headers animado">
        ...
        <div className="calendario_dias">
          {calendario.map((dia, index) => (
            ...
            >
              {dia && (
                <>
                  {diasEspeciales[dia] === "pintor" && (
                    <span className="icono_especial imagen_pintor">
                      <img
                        src="https://res.cloudinary.com/dnao6nouz/image/upload/v1758045833/image_27_xoanxu.png"
                        alt="pintor"
                      />
                    </span>
                  )}
